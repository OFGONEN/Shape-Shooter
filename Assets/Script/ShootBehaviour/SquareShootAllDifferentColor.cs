...
public class SquareShootAllDifferentColor : ShootBehaviour
{
#region Fields
#endregion
...
#region API
    public override void Shoot()
    {
		...
		var randomColorThird  = library_edge_color.GetRandomDistinctEdgeColorData();
		var randomColorFourth = library_edge_color.GetRandomDistinctEdgeColorData();
		...
		edgeShooter.Shoot( randomColorThird );

		list_edge_shooter.itemDictionary.TryGetValue( 3, out edgeShooter );
		edgeShooter.Shoot( randomColorFourth );
	}
#endregion
