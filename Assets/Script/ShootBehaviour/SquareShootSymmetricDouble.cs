...
public class SquareShootSymmetricDouble : ShootBehaviour
{
#region Fields
#endregion
...
#region API
    public override void Shoot()
    {
		...
		var shooterIndexSecond = ( shooterIndexFirst + shape_data.shape_edge_count / 2 ) % shape_data.shape_edge_count;
